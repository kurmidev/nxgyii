...
$this->params['links'] = [
    ['title' => 'Add New Sub Category', 'url' => \Yii::$app->urlManager->createUrl('plugin/add-sub-category'), 'class' => 'fa fa-plus'],
];
        ...
        'columns' => [
            ...
            [
                ...
                'content' => function ($data) {
                    return Html::a(Html::tag('i', ' <span class="path1"></span><span class="path2"></span><span class="path3"></span>', ['class' => 'ki-duotone ki-pencil fs-2 ']), \Yii::$app->urlManager->createUrl(['plugin/update-sub-category', 'id' => $data['id']]), ['title' => 'Update ' . $data['name'], 'class' => 'btn btn-primary-alt']);
                }
            ]
        ],
    ]);
