...
$parentList = ArrayHelper::map(Categories::find()->onlyParent()->active()->all(), 'id', 'name');
?>
...
<div class="card bd-0 shadow-base widget-14 ht-100p">
    <div class="card-body row g-3">
        ...
        <div class="col-md-6">
            ...
            <?= Html::activeLabel($model, 'parent_id', ['class' => ' control-label']); ?>
            <div class="col-lg-12 col-sm-12 col-xs-12">
                <?= Html::activeDropDownList($model, 'parent_id',$parentList ,['class' => 'form-control','prompt'=>"select one"]) ?>
