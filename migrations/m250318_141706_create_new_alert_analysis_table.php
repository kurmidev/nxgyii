...
/**
 * Handles the creation of table `{{%new_alert_analysis}}`.
 */
class m250318_141706_create_new_alert_analysis_table extends Migration
{
    private $tableName = "new_alert_analysis";
    /**
     * {@inheritdoc}
     */
