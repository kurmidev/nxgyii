...
/**
 * This is the model class for table "new_alert_analysis".
 *
 ...
 */
class NewAlertAnalysisModel extends ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['tenant_id', 'user_name', 'alert_severity', 'alert_severity_score', 'rpca_updated', 'alert_type', 'update_time', 'object_network_name', 'alert_id', 'situation_name', 'severity', 'alert_type_id', 'create_time', 'message', 'object_id', 'alert_status', 'prev_situation_id', 'is_uda', 'tm_id', 'alert_score', 'prev_alert_status', 'situation_id', 'recent_event_timestamp', 'is_severity_changed', 'full_name'], 'safe'],
        ];
    }
    ...
    /**
     * {@inheritdoc}
     * @return NewAlertAnalysisQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new NewAlertAnalysisQuery(get_called_class());
    }
}


class NewAlertAnalysisQuery extends \yii\db\ActiveQuery
{
    ...
    /**
     * {@inheritdoc}
     * @return NewAlertAnalysisModel[]|array
     */
    ...
    /**
     * {@inheritdoc}
     * @return NewAlertAnalysisModel|array|null
     */
